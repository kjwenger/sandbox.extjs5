...
folder are mapped to the application's root namespace, 'sandbox_extjs5'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "sandbox_extjs5"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'sandbox_extjs5' in the same way
as `"sandbox_extjs5/sass/src"`.
